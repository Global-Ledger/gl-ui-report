<template>
  <div>
    ...
    <div class="table-wrap table-wrap__unoverflow gl-table-unshadow report-table report-table__risky">
      <o-table
...
export default {
  ...
  methods: {
    ...
    findMinMaxFields,
    openInNewTab(val) {
      const { href } = this.$router.resolve({ name: 'analytics', query: { tx: val } })
      window.open(href, '_blank')
    },
    openInNewTabAddress(val) {
      const { href } = this.$router.resolve({ name: 'analytics', query: { address: val } })
      window.open(href, '_blank')
    },
  },
}
...
<style>
.report-table .o-table .o-table__td {
  max-width: 0;
  overflow: hidden;
...
.report-table .o-table .o-table__th {
  border-top: 1px solid #dbdbdb !important;
  font-size: 12px;
}

.report-table .o-table .o-table__th:last-child {
  border-right: 1px solid #dbdbdb !important;
}

.report-table .o-table .o-table__td:last-child  {
  border-right: 1px solid #dbdbdb !important;
}
...
.report-table__risky .o-table .o-table__th:first-child {
  border-left: 4px solid #ff2a00 !important;
}

.report-table__risky .o-table .o-table__td:first-child {
  border-left: 4px solid #ff2a00 !important;
}
</style>
